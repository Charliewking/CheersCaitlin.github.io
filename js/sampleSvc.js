(function () {
	...
	var serviceId = 'sampleSvc';
	
	angular.module('cheersCaitlin').factory(serviceId, sampleSvc);
	...
	},
	{
            ...
            getSamples: function () {
                ...
                /// <summary>Returns a list of all writing samples</summary> 
                /// <returns type="Object">List of all samples</returns>
